...
fun DFA (contents:string) (len_contents:int) (index:int)  (bold:int) (italics:int) (quotes:int) (heads:int)  (str_write:string) (outputfile:string)=
    ...
    if(index=len_contents) then writeToFile(outputfile,str_write^"\n")
        ...
        then 
            ...
            in
                DFA contents len_contents index bold italics quotes heads "" outputfile
            end
    ...
    then 
        ...
        in
            DFA contents len_contents (index+2) ((bold+1) mod 2) italics quotes heads "" outputfile
        end
    ...
    then
        ...
        in
            DFA contents len_contents (index+1) bold ((italics+1) mod 2) quotes heads "" outputfile
        end
        ...
        then
            ...
            in
                DFA contents len_contents (index+3) bold italics quotes heads "" outputfile
            end
    
    else if(substring(contents,index,2)="\\_")
        then DFA contents len_contents (index+2) bold italics quotes heads (str_write^" ") outputfile
        ...
        then
            ...
            in
                DFA contents len_contents index bold italics quotes heads "</ul>" outputfile
            end
    else if(substring(contents,index,1)="\n") 
        then
            let
            ...
            in
                DFA contents len_contents (index) bold italics n_quotes 0 "" outputfile
            end
    else
        DFA contents len_contents (index+1) bold italics quotes heads (str_write^substring(contents,index,1)) outputfile;
...
DFA (contents^"Raja Kumar Department of Computer Science and Engineering hai ") len_contents 0 0 0 0 0 "" "Answer.html";
