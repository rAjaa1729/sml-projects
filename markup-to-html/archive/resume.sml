...
val file_in = TextIO.openIn "inputfile.txt";
...
fun DFA (contents:string) (len_contents:int) (index:int)  (bold:int) (italics:int) (quotes : (int,int)) (str_write:string) (outputfile:string)=
    ...
    then 
        ...
        in
            DFA contents len_contents index bold italics quotes "" outputfile
        end
    ...
    then 
        ...
        in
            DFA contents len_contents (index+2) ((bold+1) mod 2) italics quotes "" outputfile
        end
    ...
    then
        ...
        in
            DFA contents len_contents (index+1) bold ((italics+1) mod 2) quotes "" outputfile
        end
        ...
        then
            ...
            in
                DFA contents len_contents (index+3) bold italics quotes "" outputfile
            end
    
    else if(substring(contents,index,2)="\\_")
        then DFA contents len_contents (index+2) bold italics quotes (str_write^" ") outputfile
        ...
        then
            ...
            in
                DFA contents len_contents index bold italics quotes "</ul>" outputfile
            end
    (* else if(substring(contents,index,1)="<")=
        then DFA contents len_contents (index+1) bold italics (#1 quotes,(#2 quotes)+1) (str_write^substring(contents,index,1)) outputfile
    else if(substring(contents,index,1)=">")=
        then if(#2 quotes>0) then DFA contents len_contents (index+1) bold italics (#1 quotes,if (#2 quotes)-1) (str_write^substring(contents,index,1)) outputfile
            else 
                let
                    val write=writeToFile(outputfile,str_write)
                    val index=blockquotes_check(contents,outputfiel,index+1,1,"")
                in
                   DFA contents len_contents (index+1) bold italics quotes "" outputfile
                end *)
    else
        DFA contents len_contents (index+1) bold italics quotes (str_write^substring(contents,index,1)) outputfile;
